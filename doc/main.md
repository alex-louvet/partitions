...
- `-f string` : Type of set system (explained in [classes.cpp](./classes.md)) among `["grid","random_hs","grid_graph","linear_grid","exponential_grid","directional_grid","random","projective_plane","ERGGraph","power_law"]`. Default: `grid`
