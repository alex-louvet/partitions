...
int main(int argc, char** argv){
    string line;
    string file = "./data/dakota-edges.txt";
    string geofile = "./data/dakota-geo.txt";
    int max = 0;
    ...
    while ((c = getopt (argc, argv, "a:n:t:d:r:e:g:c:k:s")) != -1){
        switch (c)
        {
        case 'a':
        ...
        case 'c':
            ...
            break;
        case '?':
            if (optopt == 'a' || optopt == 'n' || optopt == 't' || optopt == 'd' || optopt == 'r' || optopt == 'e' || optopt == 'g' || optopt == 'k' || optopt == 'c')
